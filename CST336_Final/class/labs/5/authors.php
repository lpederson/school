<?php
	...
	ShowHeader("Lab5 - Authors.php");
	ShowMainNav();
	ShowBreadCrumbs(__DIR__);
	
	$query = "select * from books as b,authors as a where b.author=a.authorid order by a.lastname,a.firstname";
	...
	echo '<thead><tr><th>Author </th></tr></thead>';
	$alt = 0;
	
	while ($line = mysql_fetch_assoc($results)) {
		echo '<tr'.(($alt++ & 1) ? ' bgcolor="blue"' : '').'><td>' 
		. $line['lastname'].', '.$line['firstname'].'</td></tr>';
	}
